...
<div className='flex flex-col gap-5'>
<p className='h-[7vh] font-medium text-[20px]'>Are you A Doctor? </p>
<p>Join CareKonect</p>
</div>
...
<div className='flex flex-row gap-1'>
  <div className='text-[#206E30] bg-[#BEBEBE] h-[3.4vh] w-[1.7vw] 
flex items-center justify-center rounded-3xl'>
  <FaInstagram /></div><p>Instagram</p></div>

<div className='flex flex-row gap-1'>
  <div className='text-black bg-[#BEBEBE] h-[3.4vh] w-[1.7vw] 
flex items-center justify-center rounded-3xl'>
  <FaTwitter /></div><p>Twitter</p></div>
<div className='flex flex-row gap-1'><div className='text-[#2e9743] bg-[#BEBEBE] h-[3.4vh] w-[1.7vw] 
flex items-center justify-center rounded-3xl'>
  <FaFacebookF/></div><p>Facebook</p></div>
<div className='flex flex-row gap-1'><div className='text-black bg-[#BEBEBE] h-[3.4vh] w-[1.7vw] 
flex items-center justify-center rounded-3xl'>
  <FaLinkedinIn/></div><p>LinkedIn</p></div>
  </div>
  </section>
</section>
...
<span className='text-xl'> <SiAdobe /></span>
<span>Adobe</span>
</div>
<div className='flex text-white items-center '>
  <span className='text-xl'><MdCopyright/></span>
  <p className='text-gray-300'>2024 Adobe Inc. All rights reserved.</p>
</div>
    </div>

  <div className='flex justify-between w-[47vw] text-white'>
<div className='flex items-center justify-center'><span>English
  </span> 
