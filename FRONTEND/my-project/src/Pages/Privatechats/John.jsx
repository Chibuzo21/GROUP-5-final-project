...
const Privatechat = () => {
  const [messages, setMessages] = useState([
    ...
    { text: "Hello Dr. John", sender: "user" },
    ...
    <>
      <div className="flex justify-center items-center h-screen w-screen">
        <div className=" sm:w-[80vw] h-[100vh] w-full bg-white shadow-lg rounded-lg">
          ...
          >
            <div
              className="text-4xl  cursor-pointer md:mr-10 "
              onClick={() => {
                navigate("/Chat");
              }}
            >
            ...
            <div className="flex items-center sm:w-[53vw] w-full justify-center">
              <div className="w-1/3 xl:w-1/5 md:w-1/4 sm:w-1/5 lg:w-1/5">
                {" "}
                <div className="xl:py-1 xl:px-1 lg:px-1 py-1  px-1 sm:px-1 sm:py-1 bg-gray-200 rounded-full mx-4">
                  <img src={Nurse6} alt="" srcset="" />
                </div>
              </div>
              <div className=" w-2/4 md:w-[95%] sm:w-[85%]">
                <h2 className="md:text-4xl lg:text-3xl text-lg font-semibold ">
                  Dr. John Smith
                </h2>
